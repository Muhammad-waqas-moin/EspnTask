  ...
  return (
    <>
      <div className="bg-[#03a9f4] py-4 px-4 w-full flex justify-between">
        ...
        <div className="flex justify-center items-center gap-4">
          <button className="bg-[#4A4A4A] rounded-full py-1 px-3">
            use App
          </button>
      ...
      <div className="w-full bg-blue-950  pt-12 pb-12 ">
        <div className="">
          <ul className="flex  items-center px-8 md:px-28 gap-2 md:gap-8 text">
        ...
        <div className="flex flex-wrap justify-center gap-4  pt-5">
          {detailObj &&
            detailObj[0]?.tableData[0]?.data.map((item, index) => {
              return (
                <div key={index} className="bg-[#4A4A4A] p-5 rounded">
                  <div>
                    <p className="text-lg">
